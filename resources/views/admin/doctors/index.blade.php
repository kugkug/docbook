                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu" style="position: absolute; transform: translate3d(-89px, 38px, 0px); top: 0px; left: 0px; will-change: transform;" x-placement="bottom-start">
                                        <a class="dropdown-item text-info" href="/admin/view-doctor">
                                            <i class="fa-solid fa-users-viewfinder"></i>
                                            View
                                        </a>
                                        <a class="dropdown-item text-success" href="/admin/edit-doctor">
                                            <i class="fa-solid fa-user-pen"></i>
                                            Edit
                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item text-danger" href="/admin/remove-doctor">
